...
// コンポーネント import
import { REDUCER_POSTING_ACTION, REQUEST_STATE } from '../../constants/constants';
...
export const useAuthOrdersPost = () => {
  ...
  const [ordersPostFlag, ordersDispatch] = useReducer(ordersReducer, initialOrdersPostFlag);
